...
class V2DocumentClassifyRequest(BaseModel):
    """
    ...
    possible_types: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["provider", "model", "max_tokens", "temperature", "document", "possible_types"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if possible_types (nullable) is None
        # and model_fields_set contains the field
        if self.possible_types is None and "possible_types" in self.model_fields_set:
            _dict['possible_types'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "possible_types": obj.get("possible_types")
        })
        return _obj
