...
class V2ModerationRequest(BaseModel):
    """
    ...
    content: StrictStr = Field(description="Content to moderate")
    content_type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["provider", "model", "max_tokens", "temperature", "content", "content_type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V2ModerationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V2ModerationRequest from a dict"""
        if obj is None:
            return None
