...
class V2VideoInterpolateRequest(BaseModel):
    """
    ...
    video_url: StrictStr = Field(description="URL of source video")
    target_fps: Optional[Annotated[int, Field(le=120, strict=True, ge=24)]] = None
    __properties: ClassVar[List[str]] = ["provider", "model", "max_tokens", "temperature", "video_url", "target_fps"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if target_fps (nullable) is None
        # and model_fields_set contains the field
        if self.target_fps is None and "target_fps" in self.model_fields_set:
            _dict['target_fps'] = None
