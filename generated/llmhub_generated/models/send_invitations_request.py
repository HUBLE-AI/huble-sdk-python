...
class SendInvitationsRequest(BaseModel):
    ...
    """ # noqa: E501
    invitees: Annotated[List[InviteeData], Field(min_length=1, max_length=10)] = Field(description="List of invitees (1-10)")
    __properties: ClassVar[List[str]] = ["invitees"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "invitees": [InviteeData.from_dict(_item) for _item in obj["invitees"]] if obj.get("invitees") is not None else None
        })
        return _obj
