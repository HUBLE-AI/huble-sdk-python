...
class V2TextGenerateRequest(BaseModel):
    """
    ...
    prompt: Annotated[str, Field(min_length=1, strict=True, max_length=50000)] = Field(description="Text generation prompt")
    system_prompt: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["provider", "model", "max_tokens", "temperature", "prompt", "system_prompt"]
