...
class V2DomainSearchRequest(BaseModel):
    """
    ...
    domain: Annotated[str, Field(min_length=3, strict=True, max_length=255)] = Field(description="Company domain")
    ...
    limit: Optional[Annotated[int, Field(le=100, strict=True, ge=1)]] = Field(default=10, description="Results per page")
    __properties: ClassVar[List[str]] = ["provider", "model", "max_tokens", "temperature", "domain", "company", "type", "seniority", "department", "offset", "limit"]
