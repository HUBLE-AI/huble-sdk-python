...
class SEPAListResponse(BaseModel):
    """
    SEPA payment method response for organization
    """ # noqa: E501
    success: Optional[StrictBool] = True
    sepa: Optional[SEPAResponse] = None
    has_sepa: Optional[StrictBool] = False
    __properties: ClassVar[List[str]] = ["success", "sepa", "has_sepa"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if sepa (nullable) is None
        # and model_fields_set contains the field
        if self.sepa is None and "sepa" in self.model_fields_set:
            _dict['sepa'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sepa": SEPAResponse.from_dict(obj["sepa"]) if obj.get("sepa") is not None else None,
            "has_sepa": obj.get("has_sepa") if obj.get("has_sepa") is not None else False
        })
        return _obj
