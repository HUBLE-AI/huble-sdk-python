...
class V2TextClassifyRequest(BaseModel):
    """
    ...
    categories: List[StrictStr] = Field(description="List of possible categories")
    __properties: ClassVar[List[str]] = ["provider", "model", "max_tokens", "temperature", "text", "categories"]
