...
class ImageGenerationResponse(BaseModel):
    ...
    success: StrictBool
    image_url: StrictStr
    openai_url: StrictStr
    permanent_url: Optional[StrictStr]
    revised_prompt: Optional[StrictStr]
    cost_usd: Union[StrictFloat, StrictInt]
    generation_time_ms: StrictInt
    size: StrictStr
    quality: StrictStr
    log_id: UUID
    __properties: ClassVar[List[str]] = ["success", "image_url", "openai_url", "permanent_url", "revised_prompt", "cost_usd", "generation_time_ms", "size", "quality", "log_id"]
