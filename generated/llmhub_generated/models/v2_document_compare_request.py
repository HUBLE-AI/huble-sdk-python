...
class V2DocumentCompareRequest(BaseModel):
    """
    ...
    documents: Annotated[List[StrictStr], Field(min_length=2, max_length=5)] = Field(description="Documents to compare")
    comparison_type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["provider", "model", "max_tokens", "temperature", "documents", "comparison_type"]
