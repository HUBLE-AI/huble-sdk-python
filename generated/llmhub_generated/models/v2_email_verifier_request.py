...
class V2EmailVerifierRequest(BaseModel):
    """
    ...
    email: Annotated[str, Field(min_length=5, strict=True, max_length=255)] = Field(description="Email address to verify")
    __properties: ClassVar[List[str]] = ["provider", "model", "max_tokens", "temperature", "email"]
