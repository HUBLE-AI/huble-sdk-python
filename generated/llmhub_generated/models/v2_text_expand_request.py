...
class V2TextExpandRequest(BaseModel):
    """
    ...
    target_length: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["provider", "model", "max_tokens", "temperature", "text", "target_length"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if target_length (nullable) is None
        # and model_fields_set contains the field
        if self.target_length is None and "target_length" in self.model_fields_set:
            _dict['target_length'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "text": obj.get("text"),
            "target_length": obj.get("target_length")
        })
        return _obj
