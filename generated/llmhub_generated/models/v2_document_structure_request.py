...
class V2DocumentStructureRequest(BaseModel):
    """
    ...
    document: StrictStr = Field(description="Unstructured document content")
    target_format: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["provider", "model", "max_tokens", "temperature", "document", "target_format"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if target_format (nullable) is None
        # and model_fields_set contains the field
        if self.target_format is None and "target_format" in self.model_fields_set:
            _dict['target_format'] = None
