...
class CustomerPricingListResponse(BaseModel):
    ...
    """ # noqa: E501
    success: StrictBool
    pricing_rules: List[CustomerPricingResponse]
    total_count: StrictInt
    __properties: ClassVar[List[str]] = ["success", "pricing_rules", "total_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pricing_rules": [CustomerPricingResponse.from_dict(_item) for _item in obj["pricing_rules"]] if obj.get("pricing_rules") is not None else None,
