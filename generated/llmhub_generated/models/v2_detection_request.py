...
class V2DetectionRequest(BaseModel):
    """
    ...
    content: StrictStr = Field(description="Content to analyze")
    detection_types: List[StrictStr] = Field(description="PII, hate_speech, violence, etc.")
    __properties: ClassVar[List[str]] = ["provider", "model", "max_tokens", "temperature", "content", "detection_types"]
