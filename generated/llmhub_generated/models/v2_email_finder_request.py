...
class V2EmailFinderRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["provider", "model", "max_tokens", "temperature", "domain", "first_name", "last_name", "full_name", "linkedin"]
