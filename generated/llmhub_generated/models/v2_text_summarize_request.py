...
class V2TextSummarizeRequest(BaseModel):
    """
    Summarize long text
    """ # noqa: E501
    ...
    text: Annotated[str, Field(min_length=100, strict=True, max_length=100000)]
    summary_length: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["provider", "model", "max_tokens", "temperature", "text", "summary_length"]
