...
class V2DiscoverRequest(BaseModel):
    """
    ...
    query: Annotated[str, Field(min_length=3, strict=True, max_length=500)] = Field(description="Natural language search query")
    ...
    __properties: ClassVar[List[str]] = ["provider", "model", "max_tokens", "temperature", "query", "headquarters", "industry", "offset", "limit"]
