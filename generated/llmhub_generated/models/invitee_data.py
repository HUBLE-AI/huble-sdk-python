...
class InviteeData(BaseModel):
    ...
    Single invitee data
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(description="Invitee name")
    email: StrictStr = Field(description="Invitee email address")
