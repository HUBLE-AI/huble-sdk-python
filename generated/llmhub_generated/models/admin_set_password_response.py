...
class AdminSetPasswordResponse(BaseModel):
    ...
    message: StrictStr
    user_id: UUID
    sessions_invalidated: StrictInt = Field(description="Number of sessions invalidated")
    __properties: ClassVar[List[str]] = ["success", "message", "user_id", "sessions_invalidated"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sessions_invalidated": obj.get("sessions_invalidated")
        })
        return _obj
