...
class V2DocumentGenerateRequest(BaseModel):
    """
    ...
    document_type: StrictStr = Field(description="Type of document (report, contract, whitepaper, etc.)")
    specifications: Dict[str, Any] = Field(description="Document specifications and requirements")
    __properties: ClassVar[List[str]] = ["provider", "model", "max_tokens", "temperature", "document_type", "specifications"]
