...
class V2VideoExtendRequest(BaseModel):
    """
    ...
    extend_duration: Annotated[int, Field(le=30, strict=True, ge=1)] = Field(description="Additional seconds to add")
    __properties: ClassVar[List[str]] = ["provider", "model", "max_tokens", "temperature", "video_url", "extend_duration"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "extend_duration": obj.get("extend_duration")
        })
        return _obj
