...
class V2VideoRemixRequest(BaseModel):
    """
    ...
    instructions: StrictStr = Field(description="Editing instructions")
    __properties: ClassVar[List[str]] = ["provider", "model", "max_tokens", "temperature", "video_url", "instructions"]
