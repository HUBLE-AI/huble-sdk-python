...
class V2TextExtractRequest(BaseModel):
    """
    ...
    text: Annotated[str, Field(min_length=1, strict=True, max_length=50000)]
    extract_types: Optional[List[StrictStr]] = Field(default=None, description="What to extract")
    __properties: ClassVar[List[str]] = ["provider", "model", "max_tokens", "temperature", "text", "extract_types"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "text": obj.get("text"),
            "extract_types": obj.get("extract_types")
        })
        return _obj
