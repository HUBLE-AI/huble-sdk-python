...
class V2DataRerankRequest(BaseModel):
    """
    ...
    query: Annotated[str, Field(min_length=1, strict=True, max_length=8000)] = Field(description="Search query")
    documents: Annotated[List[StrictStr], Field(min_length=1, max_length=1000)] = Field(description="List of documents to rank by relevance")
    top_k: Optional[Annotated[int, Field(strict=True, ge=1)]] = None
    __properties: ClassVar[List[str]] = ["provider", "model", "max_tokens", "temperature", "query", "documents", "top_k"]
