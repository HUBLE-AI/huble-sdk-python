...
class V2TextAnalyzeRequest(BaseModel):
    """
    ...
    analysis_types: Optional[List[StrictStr]] = Field(default=None, description="Types of analysis to perform")
    __properties: ClassVar[List[str]] = ["provider", "model", "max_tokens", "temperature", "text", "analysis_types"]
