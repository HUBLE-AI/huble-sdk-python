...
class V2LeadCreateRequest(BaseModel):
    ...
    email: StrictStr = Field(description="Lead email address")
    ...
    __properties: ClassVar[List[str]] = ["provider", "model", "max_tokens", "temperature", "email", "first_name", "last_name", "position", "company", "website", "country_code", "linkedin_url", "phone_number", "notes"]
