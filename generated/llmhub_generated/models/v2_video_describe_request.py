...
class V2VideoDescribeRequest(BaseModel):
    """
    ...
    video_url: StrictStr = Field(description="URL of video to describe")
    detail_level: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["provider", "model", "max_tokens", "temperature", "video_url", "detail_level"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if detail_level (nullable) is None
        # and model_fields_set contains the field
        if self.detail_level is None and "detail_level" in self.model_fields_set:
            _dict['detail_level'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "detail_level": obj.get("detail_level")
        })
        return _obj
