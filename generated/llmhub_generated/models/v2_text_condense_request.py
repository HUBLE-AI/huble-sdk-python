...
class V2TextCondenseRequest(BaseModel):
    """
    ...
    num_points: Optional[Annotated[int, Field(le=20, strict=True, ge=1)]] = None
    __properties: ClassVar[List[str]] = ["provider", "model", "max_tokens", "temperature", "text", "num_points"]
